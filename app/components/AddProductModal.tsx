  ...
  return (
    <Dialog open={open} onOpenChange={onClose} >
      <DialogContent className="max-w-lg ">
        ...
        <DialogHeader>
          <DialogTitle className="text-2xl text-[#4A654E]">Add New Product</DialogTitle>
          <p className="text-[#434842]">Enter details for the new floral addition.</p>
        </DialogHeader>
  ...
  {form.image && (
    ...
    />
        ...
        <DialogFooter className="mt-4 flex gap-2">
          ...
          <Button variant="outline" onClick={onClose} className="text-[#434842] rounded-xl">
            Cancel
          </Button>
