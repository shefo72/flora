...
export default function OrdersPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6 text-flora-green">
        Orders Management
      </h1>

      <table className="w-full border rounded-lg overflow-hidden">
        {/* Header */}
        <thead className="bg-[#3E6C4D42] text-left text-xl text-flora-green">
          <tr>
        ...
        <tbody>
          {orders.map((order) => (
            <tr key={order.order_id} className="border-t text-flora-green">
