...
import signupImage from '../../public/assets/images/signImage.jpg'
      ...
      <div className="flex h-screen w-full overflow-hidden bg-[#F9F7F2]">
          ...
          <div className="flex h-full flex-col justify-center px-8 md:px-16 lg:px-24">
            <div className="mx-auto w-full max-w-md">
              ...
              <p className="mb-6 text-xs leading-relaxed text-[#6B6B6B] lg:mb-8 lg:text-sm">
                Welcome to our botanical sanctuary. Please enter your details to begin your journey.
              </p>
              ...
              <form className="space-y-4 lg:space-y-5" onSubmit={handleSubmit(onSubmit)}>
                <div className='grid grid-cols-2 gap-4'>
                  ...
                  <input
                    ...
                    {...register('firstName')}
                  />
                  {errors.firstName && <p className="mt-0.5 text-[10px] text-red-500 lg:text-xs">{errors.firstName.message}</p>}
                  </div>
                  <div>
                  <label className="mb-1 block text-[10px] font-medium uppercase tracking-wider text-[#4A4A4A] lg:mb-2 lg:text-xs">
                   Last Name
                  ...
                  <input
                    ...
                    {...register('lastName')}
                  />
                  {errors.lastName && <p className="mt-0.5 text-[10px] text-red-500 lg:text-xs">{errors.lastName.message}</p>}
                </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register('email')}
                  />
                  {errors.email && <p className="mt-0.5 text-[10px] text-red-500 lg:text-xs">{errors.email.message}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register('phone')}
                  />
                  {errors.phone && <p className="mt-0.5 text-[10px] text-red-500 lg:text-xs">{errors.phone.message}</p>}
                </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      {...register('birthday')}
                    />
                      {errors.birthday && <p className="mt-0.5 text-[10px] text-red-500 lg:text-xs">{errors.birthday.message}</p>}
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      {...register('password')}
                    />
                      {errors.password && <p className="mt-0.5 text-[10px] text-red-500 lg:text-xs">{errors.password.message}</p>}
                  </div>
                  <p className="mt-1 text-[10px] text-[#8B8B8B] lg:text-xs">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <p className="mt-8 text-center text-sm text-[#8B7355]">
            ...
            <Link href="/login" className="text-[#4A5D4A] font-medium hover:underline">
              Sign in
            </Link>
          </p>
              </form>
