    ...
    return <>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-xs tracking-widest text-gray-500 uppercase">Our Ethos</p>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-gray-800 leading-tight">
              Rooted in Mindfulness,<br />
              Grown with Intent.
            </h2>
            <p className="text-gray-600 text-sm leading-relaxed">
              Petals & Bloom was born from a desire to reconnect with the seasonal rhythms of the earth. 
              We believe a bouquet is more than a gift; it's a silent messenger of grace and appreciation.
            </p>
            <p className="text-gray-600 text-sm leading-relaxed">
              We work exclusively with local artisans and sustainable farms to ensure that every stem in our studio 
              is treated with the respect it deserves, from seed to your doorstep.
            </p>
            <a href="#" className="inline-flex items-center gap-2 text-gray-800 text-sm hover:text-green-800 transition">
              Read Our Full Story 
            </a>
          </div>
