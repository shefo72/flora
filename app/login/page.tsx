        ...
        <div className="relative flex min-h-screen w-full items-center justify-center bg-[#4A5D4A]">
          ...
          <div className="relative z-10 mx-4 w-full max-w-md rounded-xl bg-[#ffffffda] p-8 shadow-2xl md:p-10">
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <a href='#' className="text-xs text-[#6B6B6B] hover:text-[#2D2D2D] cursor-pointer">
                    Forgot Password?
                  </a>
                </div>
                <input
            ...
            <div className="text-center">
              ...
              <Link href='/signup' className="text-sm font-medium text-[#2D2D2D] underline hover:no-underline cursor-pointer">
                Create an Account
              </Link>
            </div>
          </div>
