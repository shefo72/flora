      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-[#E7E5E4CC] text-sm">
            Curating moments of botanical beauty with sustainability at our
            heart.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2 text-[#E7E5E4CC] text-sm">
            <p>
              We create stunning floral arrangements that turn your moments into
              memories. Fresh flowers, elegant designs, and same-day delivery
